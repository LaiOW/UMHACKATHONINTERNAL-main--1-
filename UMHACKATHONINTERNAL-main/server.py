...
from utils import get_jam_ai_response, get_chat_history, embed_file_in_jamai, JAMAI_PROJECT_ID, JAMAI_KNOWLEDGE_TABLE_ID
...
def chat_endpoint():
    ...
    try:
        ...
        ai_response = get_jam_ai_response(JAMAI_PROJECT_ID, user_message, context, session_id=session_id, user_email=user_email)
...
if __name__ == '__main__':
    ...
    print("Go to http://localhost:5000 to see your new app!")
